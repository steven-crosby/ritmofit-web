...
CREATE TABLE `__new_class_tracks` (
	...
	`clip_end_ms` integer,
	`beat_anchor_ms` integer DEFAULT 0 NOT NULL,
	...
	CONSTRAINT "class_tracks_display_rpm_check" CHECK("__new_class_tracks"."display_rpm" is null or "__new_class_tracks"."display_rpm" > 0),
	CONSTRAINT "class_tracks_hold_count_check" CHECK("__new_class_tracks"."hold_count" is null or "__new_class_tracks"."hold_count" >= 0)
);
--> statement-breakpoint
INSERT INTO `__new_class_tracks`("id", "class_id", "track_id", "position", "intensity", "display_bpm_override", "duration_ms_override", "clip_start_ms", "clip_end_ms", "beat_anchor_ms", "start_offset_ms", "notes", "created_at", "updated_at") SELECT "id", "class_id", "track_id", "position", "intensity", "display_bpm_override", "duration_ms_override", "clip_start_ms", "clip_end_ms", "beat_anchor_ms", "start_offset_ms", "notes", "created_at", "updated_at" FROM `class_tracks`;--> statement-breakpoint
