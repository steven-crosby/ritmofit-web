...
- **Rhythmic, not busy.** One orchestrated moment beats many scattered effects. A page shouldn't shimmer.
  The pulse is the *only* sanctioned ambient-feeling motion, and it's confined to two surfaces.
...
## Live mode
Motion is at its most restrained *and* its most expressive here — a deliberate paradox. Almost nothing
