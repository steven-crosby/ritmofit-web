...
"Spotify-clean, not Nike-performance" — attractive but a _workspace_. The earlier drafts answered with
Inter (and Inter-tabular for numbers). That's legible and characterless. **The most-read glyphs in this
app are numerals** — BPM, timecodes, zones, durations. In a rhythm product, the numbers _are_ the brand.
...
- **Numbers are always the data face** in data contexts. A BPM in Inter is a bug. The mono _is_ the cue
