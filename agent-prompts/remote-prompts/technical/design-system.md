...
- **Canon**: the rule being violated, as `doc-or-file § section` (e.g.
  ...
  `AGENTS.md § Music & UI Constraints`). If you cannot point to canon, it is not a
...
3. From those sources, write down this run's **invariant checklist**. The table below is
   ...
   | Every data-bearing surface has loading / empty / error / offline / permission states | `AGENTS.md` § Music & UI Constraints, `05-components.md` |
